...
|---|---|---|
| `release/v0.1.0` | DB 스키마(v1.5), Docker, JWT 인증, 회원가입/승인 안정화 | 5월 1주차 |
...
| Tag | 시점 | 내용 |
|---|---|---|
| `v0.1.0` | 초기 세팅 완료 | 프로젝트 구조, Docker, DB Entity (Company 포함) |
| `v0.1.1` | 인증/회원가입/승인 완료 | JWT 로그인, 회원가입, 최상위 관리자 승인 흐름 |
| `v0.2.0` | 백엔드 1차 완료 | 피로도 계산 모델 전체, GPS 수신 API, TenantAccess |
