...
| AI 개발 | AI-002 | 번호판 탐지 구현 | YOLO11n 기반 번호판 영역 탐지 | YOLO Service | 유환희 | 2026-05-10 | 2026-05-13 | 예정 |
...
| AI 개발 | AI-005 | 관측 유형별 OCR 처리 | 출발/도착/고속도로/휴게소 진입·진출 관측 유형을 포함한 OCR 응답 처리 | OCR Observe API | 유환희 | 2026-05-16 | 2026-05-18 | 예정 |
...
| 프론트엔드 개발 | FE-002 | 로그인 화면 구현 | 이메일/비밀번호 로그인, JWT 저장, role/status 기반 redirect | LoginView, authStore | 백경서 | 2026-05-06 | 2026-05-08 | 예정 |
| 프론트엔드 개발 | FE-003a | 회원가입 화면 | 업체 정보 + 관리자 계정 입력, POST /api/auth/signup | SignupView | 백경서 | 2026-05-08 | 2026-05-10 | 예정 |
| 프론트엔드 개발 | FE-003b | 승인 대기 화면 | PENDING 상태 안내, 승인 후 로그인 유도 | PendingApprovalView | 백경서 | 2026-05-10 | 2026-05-11 | 예정 |
| 프론트엔드 개발 | FE-004 | 라우터 가드 구현 | role(SUPER/COMPANY) + status(PENDING/ACTIVE/등) 기반 접근 제어 | Vue Router Guard | 백경서 | 2026-05-10 | 2026-05-11 | 예정 |
| 프론트엔드 개발 | FE-005a | 최상위 관리자 홈 | 최상위 관리자 전용 대시보드 | SuperAdminDashboardView | 백경서 | 2026-05-11 | 2026-05-12 | 예정 |
| 프론트엔드 개발 | FE-005b | 가입 승인/거절 화면 | 승인 대기 목록 조회, 승인/거절/정지 처리 UI | AdminApprovalView | 백경서 | 2026-05-12 | 2026-05-13 | 예정 |
| 프론트엔드 개발 | FE-005c | 업체 관리 화면 | 업체 목록 및 상태 조회 | CompanyManagementView | 백경서 | 2026-05-13 | 2026-05-14 | 예정 |
| 프론트엔드 개발 | FE-006 | 차량 관리 화면 | 차량 등록/조회/수정/삭제 UI (소속 업체) | VehicleView | 백경서 | 2026-05-13 | 2026-05-15 | 예정 |
| 프론트엔드 개발 | FE-007 | 운전자 관리 화면 | 운전자 CRUD 및 차량 배정 UI (소속 업체) | DriverView | 백경서 | 2026-05-15 | 2026-05-17 | 예정 |
...
| 프론트엔드 개발 | FE-011a | 번호판 관측 타임라인 UI | 출발, 고속도로 관측, 휴게소 진입/진출, 도착 이벤트 표시 | PlateEventTimeline | 백경서 | 2026-05-22 | 2026-05-23 | 예정 |
...
| 테스트 및 QA | QA-001 | 백엔드 단위 테스트 | 피로도 계산, 휴식 판단, 인증, 승인 흐름 테스트 | JUnit 테스트 | 유환희 | 2026-05-20 | 2026-05-24 | 예정 |
| 테스트 및 QA | QA-002 | API 테스트 | Swagger/Postman 기반 인증, 회원가입/승인, GPS, 대시보드 API 검증 | API 테스트 결과 | 유환희 | 2026-05-22 | 2026-05-25 | 예정 |
| 테스트 및 QA | QA-003 | 프론트 통합 테스트 | 회원가입/승인 흐름, 로그인, 시뮬레이션, 대시보드, 이력 화면 검증 | FE 테스트 결과 | 백경서 | 2026-05-23 | 2026-05-26 | 예정 |
| 테스트 및 QA | QA-004 | 전체 시연 시나리오 검증 | 최상위관리자 승인→일반관리자 로그인→출발 번호판 인식→고속도로 관측→휴게소 진입/진출→GPS 시뮬→피로도 위험→도착 번호판 검증 흐름 검증 | 시연 체크리스트 | 공통 | 2026-05-25 | 2026-05-27 | 예정 |
...
| 마일스톤 | 목표 | 기간 | 완료 기준 |
|---|---|---|---|
| M1. 산출물/기반 정리 | 요구사항, DB(company 포함), 구조도, WBS, 브랜치 전략, 최상위 관리자 구조 확정 | 2026-04-28 ~ 2026-04-30 | 핵심 산출물 v1.5 완료 |
| M2. 인프라/기본 구조 | BE/FE/AI/SIM/DB 기본 실행 구조 확보 | 2026-04-30 ~ 2026-05-06 | 각 모듈 로컬 실행 가능 |
| M3. 인증/관리 기능 | 회원가입/승인, 최상위관리자 API, 차량/운전자 관리 구현 | 2026-05-06 ~ 2026-05-13 | 회원가입→승인→로그인 흐름 동작 |
